    ...
    do i = 1, im
       if ( flag(i) ) then
          ...
          if (alat .ge. 7.64 .and. alat .le. 7.68 .and. alon .ge. 89.8 .and. alon .le. 90.8) then
             ...
             !     flag_guess(i),wind(i)
             write(221,'(i6,16e12.4)')kdt,solhr,nswsfc(i),hflx(i),evap(i),ulwflx(i),dlwflx(i),omg_sh*qrain(i),wind(i),&
                  tref(i),tskin(i),tsurf(i),rch(i),stress(i),ps(i),ustar_a,sep
          end if
          if (alat .ge. 5.70 .and. alat .le. 5.8 .and. alon .ge. 78.4 .and. alon .le. 78.6) then
             ...
             !     flag_guess(i),wind(i)
             write(222,'(i6,16e12.4)')kdt,solhr,nswsfc(i),hflx(i),evap(i),ulwflx(i),dlwflx(i),omg_sh*qrain(i),wind(i),&
                  tref(i),tskin(i),tsurf(i),rch(i),stress(i),ps(i),ustar_a,sep
          end if
